...
import { Star, ChevronDown, ChevronRight, Plus, Minus, MapPin, Calendar, Clock, ArrowLeft, Home, Building, Store, Wrench, Camera, Image as ImageIcon, Wallet, Ticket, CheckCircle, Search, X, Upload, CreditCard, AlertCircle, Info } from 'lucide-react';
            ...
            <div className="container mx-auto px-4 md:px-8 py-8 md:py-12">
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="flex-1 space-y-8">
                        ...
                        {/* Header Title */}
                        <div>
                            <h1 className="text-3xl font-extrabold text-blue-900 mb-2">Butuh Jasa Tukang + Material?</h1>
                            <p className="text-gray-500">Bizza Solusi tepat untuk rumahmu!</p>
                        </div>
                                ...
                                {[
                                    ...
                                    <div
                                        ...
                                        className={`cursor-pointer rounded-2xl p-4 flex flex-col items-center justify-center gap-3 border-2 transition-all h-32
                                            ${propertyType === type.id ? 'border-blue-500 bg-blue-50 text-blue-700' : 'border-gray-200 bg-white text-gray-600 hover:border-blue-200'}
                                        `}
                                    >
                                        <type.icon className={`w-8 h-8 ${propertyType === type.id ? 'text-blue-500' : 'text-gray-400'}`} />
                        ...
                        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
                            <h2 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                                ...
                                Perbaikan/pekerjaan bangunan yang dibutuhkan
                            </h2>
                            <textarea
                                value={description}
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="space-y-4 mb-8">
                                        <div className="flex justify-between items-center text-sm">
                                            <span className="text-gray-500">Biaya Survey</span>
