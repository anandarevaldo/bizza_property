            ...
            <div className="bg-white rounded-[2.5rem] w-full max-w-md max-h-[95vh] flex flex-col shadow-2xl overflow-hidden animate-slide-up">
                ...
                <div className="p-6 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white z-10">
                    <div>
                        ...
                        <p className="text-xs text-gray-500 font-bold uppercase tracking-wider mt-1">Scan & Upload Bukti Bisnis</p>
                    </div>
                ...
                <div className="p-8 overflow-y-auto flex-1 custom-scrollbar">
                    ...
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <div className="text-center space-y-2">
                            ...
                            <p className="text-sm text-gray-500 font-medium px-4">Buka aplikasi mobile banking atau e-wallet untuk kebutuhan pembayaran bisnis Anda.</p>
                        </div>
                    </div>
                        ...
                        {!paymentProof ? (
                            ...
                            >
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-xs text-gray-400 font-bold mt-1">Maksimum 5MB</p>
                                </div>
                            </div>
                        ) : (
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex items-center gap-1.5 text-blue-600">
                                            ...
                                            <span className="text-xs font-black uppercase tracking-wider text-blue-500">Siap dikirim</span>
                                        </div>
                                    </div>
                                    <button 
                                        onClick={() => {
