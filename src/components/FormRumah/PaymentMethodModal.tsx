            ...
            <div className="bg-white rounded-[2.5rem] w-full max-w-md max-h-[95vh] flex flex-col shadow-2xl overflow-hidden animate-slide-up">
                ...
                <div className="p-6 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white z-10">
                    <div>
                        ...
                        <p className="text-xs text-gray-500 font-bold uppercase tracking-wider mt-1">Scan & Upload Bukti</p>
                    </div>
                ...
                <div className="p-8 border-t border-gray-100 bg-white">
                    ...
                    <p className="text-center text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-4">Pesanan akan diproses setelah verifikasi bukti pembayaran</p>
                </div>
            </div>
        </div>
    );
