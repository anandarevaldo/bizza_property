                    ...
                    <div className="relative z-10">
                        ...
                        <div className="space-y-4 mb-8">
                            ...
                            <div className="flex justify-between items-center text-sm mb-3">
                                <span className="text-gray-500">Jasa Tukang</span>
                            ...
                            {selectedMaterialsCount > 0 && (
                                <div className="flex justify-between items-center text-sm">
                                    <span className="text-gray-500">Material ({selectedMaterialsCount} Jenis)</span>
                                    <span className="font-bold text-gray-900">{formattedPrice(totalMaterialPrice)}</span>
                                </div>
                            )}
