...
interface FinisihingInteriorProps {
    onSelectHandyman: (name: string) => void;
}

const FinisihingInterior: React.FC<FinisihingInteriorProps> = ({ onSelectHandyman }) => {
    const ids = ['cat', 'keramik', 'aluminium_aksesoris', 'sanitair'];
...
export default FinisihingInterior;
