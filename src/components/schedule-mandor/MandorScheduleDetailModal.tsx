...
export const MandorScheduleDetailModal: React.FC<ScheduleDetailModalProps> = ({ isOpen, onClose, schedule, onEdit }) => {
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="bg-white border-2 border-gray-100 p-5 rounded-2xl">
                        <h4 className="font-bold text-gray-900 mb-3 flex items-center gap-2 text-sm">
                            <HardHat className="w-4 h-4 text-orange-500" /> Tukang Yang Bertugas
                        </h4>
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1">
                                <p className="font-bold text-gray-900 text-sm">{schedule.handymanName || 'Belum Ditugaskan'}</p>
